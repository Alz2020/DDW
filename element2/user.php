...
session_start();
// Retrieve user's name and email from session after login
...
// Function to generate page title with user email
function generatePageTitle($user_email) {
    $title = "USN Dietary Supplement";
    if (!empty($user_email)) {
        $title .= " - Welcome, EMAIL";
    }
    return $title;
	...
	<header>
		...
		<div id="product-list" class="products">
			...
			<section class="product-box">
				<h2>SALE</h2>
				<a class="product-img">
					<img src="img/Diet Fuel.png" alt="USN whey-protein-isolate">
					<!--img-->
				</a>
